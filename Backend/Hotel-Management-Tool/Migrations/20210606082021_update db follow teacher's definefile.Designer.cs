...
namespace Hotel.Management.Tool.Migrations
{
    ...
    [Migration("20210606082021_update db follow teacher's definefile")]
    partial class updatedbfollowteachersdefinefile
    {
            ...
            modelBuilder.Entity("Hotel.Management.Tool.Core.Entities.BookingDetail", b =>
                {
                    ...
                    b.HasOne("Hotel.Management.Tool.Core.Entities.CustomerType", "CustomerType")
                        ...
                        .HasForeignKey("Hotel.Management.Tool.Core.Entities.BookingDetail", "CustomerTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
